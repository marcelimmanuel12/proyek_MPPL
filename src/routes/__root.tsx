...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "SehatKu — Kesehatan Anda, Setiap Hari" },
      { property: "og:description", content: "Pantau kesehatan harian dengan AI personal, pengingat pintar, dan komunitas suportif." },
