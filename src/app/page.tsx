...
const features = [
  {
    ...
    desc: "Check-in kesehatan setiap 5 jam, dianalisis oleh AI.",
  },
  {
    icon: Brain,
    title: "AI Konsultasi & Gejala",
    desc: "Tanya gejala, dapatkan analisis cepat dan rekomendasi.",
  },
  {
    icon: Bell,
    title: "Pengingat Pintar",
    desc: "Obat, tidur, olahraga, dan check-up — tidak ada yang terlewat.",
  },
  {
    icon: Sparkles,
    title: "Avatar Kesehatan",
    desc: "Visualisasi suasana kesehatan & progress mingguan.",
  },
  {
    icon: Users,
    title: "Komunitas & Challenge",
    desc: "Forum kesehatan dan tantangan bersama.",
  },
  {
    icon: MapPin,
    title: "Peta Rumah Sakit",
    desc: "Temukan layanan medis terdekat saat dibutuhkan.",
  },
];
      ...
      <nav className="border-b border-border/60 bg-background/80 backdrop-blur sticky top-0 z-40">
        <div className="container mx-auto flex items-center justify-between px-6 py-4">
          ...
          <div className="flex items-center gap-3">
            ...
            <Link href="/login">
              <Button className="gradient-hero text-white shadow-elegant hover:opacity-95">
                Mulai Gratis
              </Button>
            </Link>
          </div>
        ...
        <div className="container mx-auto px-6 py-16 md:py-24 grid lg:grid-cols-2 gap-12 items-center">
          <div className="text-center lg:text-left">
            ...
            <p className="mt-5 text-base md:text-lg text-muted-foreground max-w-xl mx-auto lg:mx-0">
              Monitoring kesehatan berkelanjutan dengan AI. Catat, konsultasi, dan dapatkan
              rekomendasi pola hidup sehat — semua dalam satu tempat.
            </p>
            ...
            <div className="mt-8 flex flex-wrap gap-5 justify-center lg:justify-start text-sm text-muted-foreground">
              <span className="flex items-center gap-1.5">
                <ShieldCheck className="h-4 w-4 text-teal" /> Data terenkripsi
              </span>
              <span className="flex items-center gap-1.5">
                <Clock className="h-4 w-4 text-teal" /> Check-in 5 jam
              </span>
              <span className="flex items-center gap-1.5">
                <Brain className="h-4 w-4 text-teal" /> AI 24/7
              </span>
            </div>
          </div>
      ...
      <section className="container mx-auto px-6 py-20">
        <div className="text-center max-w-2xl mx-auto mb-14">
          ...
          <p className="mt-3 text-muted-foreground">
            Dari pengingat obat sampai analisis gejala — terhubung dalam satu dashboard personal.
          </p>
        </div>
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-5">
          {features.map((f) => (
            <div
              key={f.title}
              className="group p-7 rounded-2xl border border-border bg-card shadow-card hover:shadow-elegant transition-all hover:-translate-y-1"
            >
      ...
      <section className="container mx-auto px-6 py-20">
        <div className="rounded-3xl gradient-hero p-12 md:p-16 text-center shadow-elegant">
          ...
          <p className="mt-4 text-white/80 max-w-xl mx-auto">
            Gratis. AI akan memandumu sejak hari pertama.
          </p>
          <Link href="/login">
            <Button
              size="lg"
              className="mt-8 bg-white text-primary hover:bg-white/90 h-12 px-8 text-base"
            >
